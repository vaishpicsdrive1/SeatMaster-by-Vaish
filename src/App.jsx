...
export default function App() {
  ...
  const [showBaristaLogin, setShowBaristaLogin] = useState(false)
  ...
  }, [lastUpdated, reminderIntervalMs, role])
        ...
        <main className="mx-auto flex w-full max-w-[500px] flex-col gap-6">
          <header className="text-center">
            ...
            <p className="mt-2 text-sm text-[#4b5563]">
              Choose your view so we can show the right controls.
            </p>
          </header>
          ...
          <section className="rounded-3xl bg-white p-4 shadow-soft ring-1 ring-[#cbe7dd]">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="rounded-2xl border border-[#cbe7dd] px-3 py-1 text-xs font-semibold text-[#111827] shadow-sm"
                >
                  {locations.map((loc) => (
            ...
            {showAddLocation ? (
              <div className="mt-3 flex items-center gap-2">
                ...
                />
                <button
                  className="rounded-2xl bg-emerald-500 px-3 py-2 text-sm font-semibold text-white shadow-soft hover:bg-emerald-600"
                  onClick={() => {
                ...
                <button
                  className="rounded-2xl border border-slate-200 px-3 py-2 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-50"
                  onClick={() => {
                    setNewLocationName("")
                    setShowAddLocation(false)
                  }}
          ...
          <section className="grid gap-4">
            <button
              className="w-full rounded-3xl bg-[#00754a] px-4 py-4 text-left text-sm font-semibold text-emerald-50 shadow-soft hover:bg-[#006241]"
              onClick={() => {
              setRole("barista")
                setSelectedBranch(location)
                setBaristaStep("browse")
                setBaristaLoginStatus("")
                setBaristaSearchTerm("")
                setShowBaristaLogin(true)
              }}
            >
              ...
              <p className="mt-1 text-base">
                Update seat availability and get a reminder ping every minute.
              </p>
            </button>

            <button
              className="w-full rounded-3xl bg-white px-4 py-4 text-left text-sm font-semibold text-[#1e3932] shadow-soft ring-1 ring-[#cbe7dd] hover:bg-[#f5f0e8]"
            ...
            >
              ...
              <p className="mt-1 text-base">
                Quickly see how full the store feels right now.
              </p>
            </button>
          </section>
        </main>
    ...
    <div className="min-h-screen bg-[#f5f0e8] px-4 py-10">
      <main className="mx-auto flex w-full max-w-[500px] flex-col gap-6">
        <header className="text-center">
          ...
          <button
            className="mt-4 text-xs font-semibold text-[#00754a] underline"
            onClick={() => {
              setRole(null)
              setMessage("")
            }}
        ...
        {role === "barista" ? (
          ...
          <section className="rounded-3xl bg-white p-6 shadow-soft ring-1 ring-[#cbe7dd]">
            ...
            <p className="mt-1 text-xs text-[#6b7280]">
              Baristas are reminded to refresh this about {reminderFrequencyLabel}.
            </p>
